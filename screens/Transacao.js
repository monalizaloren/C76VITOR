...
export default class Trade extends Component{
    ...
    fazerTransação = async()=>{
        ...
        retornoElegível = async(studentId, bookId) => {
            ...
            var elegivel = "";
                transactionRef.docs.map(doc => {
                    ...
                    if(ultimatransacao.student_id === studentId){
        ...
        //Retirada do livro
        retirarLivro = async (bookId, studentId, bookName, studentName) => {
        ...
        //Devolução do livro
        devolverLivro = async (bookId, studentId, bookName, studentName) => {
